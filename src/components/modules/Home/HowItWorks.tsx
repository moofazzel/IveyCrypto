...
const steps = [
  {
    id: "01",
    title: "Contact Us",
    desc: "Click the “Book a Free Consultation” to get in touch.",
    Icon: PhoneCall,
  },
  {
    id: "02",
    title: "Choose Services",
    desc: "Tell us what you’re looking for — we’ll tailor the stack.",
    Icon: Boxes,
  },
  {
    id: "03",
    title: "Stay In Peace",
    desc: "We handle it end-to-end while you focus on growth.",
    Icon: Shield,
  },
];
    ...
    <section className="relative bg-[#0C0912] text-white pb-20 pt-10 ">
      <div className="container mx-auto max-w-7xl px-4">
        ...
        <p className="text-center text-white/70 mb-14">
          Contact us, select your services, and let us manage your crypto.
        </p>
        ...
        <div className="relative flex flex-wrap items-start justify-between gap-4 md:gap-6 mt-[120px]">
          {steps.map(({ id, title, desc, Icon }) => (
            ...
            >
              ...
              <div className="pt-10">
                <h3 className="text-lg md:text-[30px] font-semibold mb-2">
                  {title}
                </h3>
